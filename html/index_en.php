    ...
    <body>    
		...
		<nav id="off-canvas-right" data-side="right" class="navmenu navmenu-default navmenu-fixed-left off-canvas visible-xs" role="navigation">
			...
			<div class="inner-nav">
				...
				<ul class="list-unstyled">
					...
					<li><a href="#" data-id-scroll="hacemos" data-pixel-fix="0">WHAT WE DO</a></li>
					<li><a href="#" data-id-scroll="equipo" data-pixel-fix="0">TEAM</a></li>
					<li><a href="#" data-id-scroll="clientes" data-pixel-fix="0">CLIENTS</a></li>
					<li><a href="#" data-id-scroll="contacto" data-pixel-fix="0">CONTACT</a></li>
		...
		<main class="wrapper public" role="main">
			...
			<section id="home" class="home in">
				...
				<div class="block-screen" data-background-2x="img/img-home.jpg" data-background="img/img-home.jpg">
					...
					<div class="text-center block-translateY">
						...
						<h1 class="h1 text-color-white">Digital <strong class="text-color-secondary">talent search</strong></h1>
						<h2 class="h3 text-color-white">More than 20 years leading digital companies.<br />Our experience in the industry is unique to select the best digital talent for your company.</h2>
				...
				<div class="container">
					...
					<div class="row margin-b-30">
						<div class="col-sm-12 text-center">
							<h2 class="h2 text-color-secondary">What we do</h2>
							<h3 class="h3">We know from the inside, the digital industry and the digital positions.</h3>
						</div>
					</div>
			...
			<section id="equipo"  class="in" data-background-2x="img/img-team.jpg" data-background="img/img-team.jpg">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="h2 text-color-secondary">Team</h2>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-sm-7">
							<h2 class="h2 text-color-white">Manolo Vizuete / director</h2>
							<p class="text-color-white">Manolo has been more than 20 years leading digital teams in different areas.</p>
							...
							<p class="text-color-white">During his career, Manolo has managed change processes, has leaded innovative business initiatives, and he has select talent for every team he has created (start-ups, multinational companies and personal projecs.</p>
							
							<p class="text-color-white">We have also a freelancers team specialized in different areas, based on every project.</p>
			...
			<section id="clientes" class="in">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="h2 text-color-secondary">Clients</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
			...
			<section id="contacto" data-background-2x="img/img-contact.jpg" data-background="img/img-contact.jpg" class="in">
				...
				<div class="container">
					<div class="row margin-b-70">
						<div class="col-sm-12 text-center">
							<h2 class="h2 text-color-secondary">Contact</h2>
							<h2 class="h3 text-color-white">Tell us what you need and we will help you</h2>
							...
							<form method="post" action="thanks.php">
								<div class="block-form">
								  ...
								  <div class="form-group">
										...
										<textarea id="tellus" name="message" required="">Message</textarea>

		
								  </div>					
								  <div class="form-group">
									<input type="submit" name="submit" id="" class="btn btn-secondary pull-right" value="Send">
    	...
    	<footer class="hide-canvas-in">
			...
			<div class="container">
				...
				<div class="row">
						<div class="col-sm-12">
							<small>©DIGITALHUNTING 2017 - ALL RIGHTS RESERVED - .</small>
						</div>		
